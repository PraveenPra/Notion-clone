...
const onRemove = (
    ...
    // if we are looking at the document we just deleted then we have to get redirected else error
    if(params.documentId === documentId){
        router.push("/documents")
    }
}

//documents are loading/fetching
...
<div  
role="button"
    onClick={()=>onRestore(e,document._id)}
